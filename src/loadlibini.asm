...
;include 'struct.inc'
include '../../kolibrios/programs/proc32.inc'
include '../../kolibrios/programs/macros.inc'
purge section,mov,add,sub

include '../../kolibrios/programs/dll.inc'
...
import	lib_libini, \
		...
		LIBINI_del_section  			, 'ini_del_section'
...
public LIBINI_get_shortcut  		as	'_LIBINI_get_shortcut'
public LIBINI_del_section   		as	'_LIBINI_del_section'
